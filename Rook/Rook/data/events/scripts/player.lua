...
function Player:onGainExperience(source, exp, rawExp)
	...
	-- Variant monster experience multiplier (same as health multiplier)
	if source:isMonster() and MonsterVariants and MonsterVariants.tiers then
		local skull = source:getSkull()
		local mult = 1.0
		if skull == SKULL_GREEN and MonsterVariants.tiers[1] then
			mult = tonumber(MonsterVariants.tiers[1].multiplier) or 1.0
		elseif skull == SKULL_ORANGE and MonsterVariants.tiers[2] then
			mult = tonumber(MonsterVariants.tiers[2].multiplier) or 1.0
		elseif skull == SKULL_RED and MonsterVariants.tiers[3] then
			mult = tonumber(MonsterVariants.tiers[3].multiplier) or 1.0
		end
		if mult ~= 1.0 then
			exp = exp * mult
		end
