...
function action.onUse(player, item, fromPosition, target, toPosition)
	if item:getId() == 1945 then
		...
		-- Build bridge on OTS water ids (508/509)
		Game.transformItemInPosition({x = 32100, y = 32205, z = 08}, 508, 1284)
		Game.transformItemInPosition({x = 32101, y = 32205, z = 08}, 509, 1284)
		-- Clear dirt tiles if present (TVP behavior)
	...
	elseif item:getId() == 1946 then
		...
		-- Restore water
		Game.transformItemInPosition({x = 32100, y = 32205, z = 08}, 1284, 508)
		Game.transformItemInPosition({x = 32101, y = 32205, z = 08}, 1284, 509)
		-- Restore dirt tiles (TVP behavior)
