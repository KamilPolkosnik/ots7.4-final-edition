...
if not doAddQuestPoint then
	function doAddQuestPoint(cid, amount)
		local points = tonumber(amount) or 1
		local current = getPlayerStorageValue(cid, 90000)
		if current < 0 then
			current = 0
		end
		setPlayerStorageValue(cid, 90000, current + points)
		return true
	end
end

function onUse(cid, item, frompos, item2, topos)
local isGM = (getPlayerAccess(cid) and getPlayerAccess(cid) > 0)
if not isGM and getPlayerGroupId then
	isGM = getPlayerGroupId(cid) >= 4
end
-- Key 4009 --
if item.uid == 8001 then
	if isGM or getPlayerStorageValue(cid,8001) <= 0 then
...
elseif item.uid == 8002 then
	if isGM or getPlayerStorageValue(cid,8002) <= 0 then
...
elseif item.uid == 8003 then
	if isGM or getPlayerStorageValue(cid,8003) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8004 then
	if isGM or getPlayerStorageValue(cid,8004) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8005 then
	if isGM or getPlayerStorageValue(cid,8005) <= 0 then
...
elseif item.uid == 8006 then
	if isGM or getPlayerStorageValue(cid,8006) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8007 then
	if isGM or getPlayerStorageValue(cid,8007) <= 0 then
...
elseif item.uid == 8008 then
	if isGM or getPlayerStorageValue(cid,8008) <= 0 then
...
elseif item.uid == 8009 then
	if isGM or getPlayerStorageValue(cid,8009) <= 0 then
...
elseif item.uid == 8010 then
	if isGM or getPlayerStorageValue(cid,8010) <= 0 then
...
elseif item.uid == 8011 then
	if isGM or getPlayerStorageValue(cid,8011) <= 0 then
...
elseif item.uid == 8012 then
	if isGM or getPlayerStorageValue(cid,8012) <= 0 then
		if getPlayerFreeCap(cid) <= 80 then
		doPlayerSendTextMessage(cid,22,"You need 80 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8013 then
	if isGM or getPlayerStorageValue(cid,8013) <= 0 then
...
elseif item.uid == 8014 then
	if isGM or getPlayerStorageValue(cid,8014) <= 0 then
...
elseif item.uid == 8015 then
	if isGM or getPlayerStorageValue(cid,8015) <= 0 then
...
elseif item.uid == 8016 then
	if isGM or getPlayerStorageValue(cid,8016) <= 0 then
...
elseif item.uid == 8017 then
	if isGM or getPlayerStorageValue(cid,8017) <= 0 then
...
elseif item.uid == 8018 then
	if isGM or getPlayerStorageValue(cid,8018) <= 0 then
		if getPlayerFreeCap(cid) <= 2 then
		doPlayerSendTextMessage(cid,22,"You need 2 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8019 then
	if isGM or getPlayerStorageValue(cid,8019) <= 0 then
...
elseif item.uid == 8020 then
	if isGM or getPlayerStorageValue(cid,8020) <= 0 then
...
elseif item.uid == 8021 then
	if isGM or getPlayerStorageValue(cid,8021) <= 0 then
...
elseif item.uid == 8022 then
	if isGM or getPlayerStorageValue(cid,8022) <= 0 then
...
elseif item.uid == 8023 then
	if isGM or getPlayerStorageValue(cid,8023) <= 0 then
...
elseif item.uid == 8024 then
	if isGM or getPlayerStorageValue(cid,8024) <= 0 then
		if getPlayerFreeCap(cid) <= 2 then
		doPlayerSendTextMessage(cid,22,"You need 2 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8025 then
	if isGM or getPlayerStorageValue(cid,8025) <= 0 then
...
elseif item.uid == 8026 then
	if isGM or getPlayerStorageValue(cid,8026) <= 0 then
...
elseif item.uid == 8027 then
	if isGM or getPlayerStorageValue(cid,8027) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8028 then
	if isGM or getPlayerStorageValue(cid,8028) <= 0 then
		if getPlayerFreeCap(cid) <= 82 then
		doPlayerSendTextMessage(cid,22,"You need 82 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8029 then
	if isGM or getPlayerStorageValue(cid,8029) <= 0 then
...
elseif item.uid == 8030 then
	if isGM or getPlayerStorageValue(cid,8030) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8031 then
	if isGM or getPlayerStorageValue(cid,8031) <= 0 then
...
elseif item.uid == 8032 then
	if isGM or getPlayerStorageValue(cid,8032) <= 0 then
...
elseif item.uid == 8033 then
	if isGM or getPlayerStorageValue(cid,8033) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8034 then
	if isGM or getPlayerStorageValue(cid,8034) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8035 then
	if isGM or getPlayerStorageValue(cid,8035) <= 0 then
...
elseif item.uid == 8036 then
	if isGM or getPlayerStorageValue(cid,8036) <= 0 then
		if getPlayerFreeCap(cid) <= 26 then
		doPlayerSendTextMessage(cid,22,"You need 26 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8037 then
	if isGM or getPlayerStorageValue(cid,8037) <= 0 then
		if getPlayerFreeCap(cid) <= 29 then
		doPlayerSendTextMessage(cid,22,"You need 29 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8038 then
	if isGM or getPlayerStorageValue(cid,8038) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8039 then
	if isGM or getPlayerStorageValue(cid,8039) <= 0 then
		if getPlayerFreeCap(cid) <= 50 then
		doPlayerSendTextMessage(cid,22,"You need 50 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8040 then
	if isGM or getPlayerStorageValue(cid,8040) <= 0 then
...
elseif item.uid == 8041 then
	if isGM or getPlayerStorageValue(cid,8041) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8042 then
	if isGM or getPlayerStorageValue(cid,8042) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8043 then
	if isGM or getPlayerStorageValue(cid,8043) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8044 then
	if isGM or getPlayerStorageValue(cid,8044) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8045 then
	if isGM or getPlayerStorageValue(cid,8045) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8046 then
	if isGM or getPlayerStorageValue(cid,8046) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8047 then
	if isGM or getPlayerStorageValue(cid,8047) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8048 then
	if isGM or getPlayerStorageValue(cid,8048) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8049 then
	if isGM or getPlayerStorageValue(cid,8049) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8050 then
	if isGM or getPlayerStorageValue(cid,8050) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8051 then
	if isGM or getPlayerStorageValue(cid,8051) <= 0 then
...
elseif item.uid == 8052 then
	if isGM or getPlayerStorageValue(cid,8052) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8053 then
	if isGM or getPlayerStorageValue(cid,8053) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8054 then
	if isGM or getPlayerStorageValue(cid,8054) <= 0 then
...
elseif item.uid == 8055 then
	if isGM or getPlayerStorageValue(cid,8055) <= 0 then
...
elseif item.uid == 8056 then
	if isGM or getPlayerStorageValue(cid,8056) <= 0 then
...
elseif item.uid == 8057 then
	if isGM or getPlayerStorageValue(cid,8057) <= 0 then
		if getPlayerFreeCap(cid) <= 30 then
		doPlayerSendTextMessage(cid,22,"You need 30 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8058 then
	if isGM or getPlayerStorageValue(cid,8058) <= 0 then
...
elseif item.uid == 8059 then
	if isGM or getPlayerStorageValue(cid,8059) <= 0 then
...
elseif item.uid == 8060 then
	if isGM or getPlayerStorageValue(cid,8060) <= 0 then
		if getPlayerFreeCap(cid) <= 2 then
		doPlayerSendTextMessage(cid,22,"You need 2 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8061 then
	if isGM or getPlayerStorageValue(cid,8061) <= 0 then
...
elseif item.uid == 8062 then
	if isGM or getPlayerStorageValue(cid,8062) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8063 then
	if isGM or getPlayerStorageValue(cid,8063) <= 0 then
...
elseif item.uid == 8064 then
	if isGM or getPlayerStorageValue(cid,8064) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8065 then
	if isGM or getPlayerStorageValue(cid,8065) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8066 then
	if isGM or getPlayerStorageValue(cid,8066) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8067 then
	if isGM or getPlayerStorageValue(cid,8067) <= 0 then
...
elseif item.uid == 8068 then
	if isGM or getPlayerStorageValue(cid,8068) <= 0 then
...
elseif item.uid == 8069 then
	if isGM or getPlayerStorageValue(cid,8069) <= 0 then
...
elseif item.uid == 8070 then
	if isGM or getPlayerStorageValue(cid,8070) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8071 then
	if isGM or getPlayerStorageValue(cid,8071) <= 0 then
		if getPlayerFreeCap(cid) <= 10 then
		doPlayerSendTextMessage(cid,22,"You need 10 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8072 then
	if isGM or getPlayerStorageValue(cid,8072) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8073 then
	if isGM or getPlayerStorageValue(cid,8073) <= 0 then
...
elseif item.uid == 8074 then
	if isGM or getPlayerStorageValue(cid,8074) <= 0 then
		if getPlayerFreeCap(cid) <= 68 then
		doPlayerSendTextMessage(cid,22,"You need 68 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8075 then
	if isGM or getPlayerStorageValue(cid,8075) <= 0 then
...
elseif item.uid == 8076 then
	if isGM or getPlayerStorageValue(cid,8076) <= 0 then
		if getPlayerFreeCap(cid) <= 50 then
		doPlayerSendTextMessage(cid,22,"You need 50 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8077 then
	if isGM or getPlayerStorageValue(cid,8077) <= 0 then
		if getPlayerFreeCap(cid) <= 82 then
		doPlayerSendTextMessage(cid,22,"You need 82 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8078 then
	if isGM or getPlayerStorageValue(cid,8078) <= 0 then
		if getPlayerFreeCap(cid) <= 80 then
		doPlayerSendTextMessage(cid,22,"You need 80 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8079 then
	if isGM or getPlayerStorageValue(cid,8079) <= 0 then
		if getPlayerFreeCap(cid) <= 5 then
		doPlayerSendTextMessage(cid,22,"You need 5 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8080 then
	if isGM or getPlayerStorageValue(cid,8080) <= 0 then
...
elseif item.uid == 8081 then
	if isGM or getPlayerStorageValue(cid,8081) <= 0 then
...
elseif item.uid == 8082 then
	if isGM or getPlayerStorageValue(cid,8082) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8083 then
	if isGM or getPlayerStorageValue(cid,8083) <= 0 then
		if getPlayerFreeCap(cid) <= 16 then
		doPlayerSendTextMessage(cid,22,"You need 16 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8084 then
	if isGM or getPlayerStorageValue(cid,8084) <= 0 then
		if getPlayerFreeCap(cid) <= 80 then
		doPlayerSendTextMessage(cid,22,"You need 80 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8085 then
	if isGM or getPlayerStorageValue(cid,8085) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8087 then
	if isGM or getPlayerStorageValue(cid,8087) <= 0 then
...
elseif item.uid == 8088 then
	if isGM or getPlayerStorageValue(cid,8088) <= 0 then
...
elseif item.uid == 8089 then
	if isGM or getPlayerStorageValue(cid,8089) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8090 then
	if isGM or getPlayerStorageValue(cid,8090) <= 0 then
...
elseif item.uid == 8091 then
	if isGM or getPlayerStorageValue(cid,8091) <= 0 then
		if getPlayerFreeCap(cid) <= 80 then
		doPlayerSendTextMessage(cid,22,"You need 80 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8092 then
	if isGM or getPlayerStorageValue(cid,8092) <= 0 then
		if getPlayerFreeCap(cid) <= 120 then
		doPlayerSendTextMessage(cid,22,"You need 120 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8093 then
	if isGM or getPlayerStorageValue(cid,8093) <= 0 then
		if getPlayerFreeCap(cid) <= 30 then
		doPlayerSendTextMessage(cid,22,"You need 30 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8094 then
	if isGM or getPlayerStorageValue(cid,8094) <= 0 then
		if getPlayerFreeCap(cid) <= 120 then
		doPlayerSendTextMessage(cid,22,"You need 120 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8095 then
	if isGM or getPlayerStorageValue(cid,8095) <= 0 then
		if getPlayerFreeCap(cid) <= 59 then
		doPlayerSendTextMessage(cid,22,"You need 59 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8096 then
	if isGM or getPlayerStorageValue(cid,8096) <= 0 then
		if getPlayerFreeCap(cid) <= 23 then
		doPlayerSendTextMessage(cid,22,"You need 23 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8097 then
	if isGM or getPlayerStorageValue(cid,8097) <= 0 then
		if getPlayerFreeCap(cid) <= 26 then
		doPlayerSendTextMessage(cid,22,"You need 26 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8098 then
	if isGM or getPlayerStorageValue(cid,8098) <= 0 then
...
elseif item.uid == 8099 then
	if isGM or getPlayerStorageValue(cid,8099) <= 0 then
		if getPlayerFreeCap(cid) <= 10 then
		doPlayerSendTextMessage(cid,22,"You need 10 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8100 then
	if isGM or getPlayerStorageValue(cid,8100) <= 0 then
...
elseif item.uid == 8101 then
	if isGM or getPlayerStorageValue(cid,8101) <= 0 then
		if getPlayerFreeCap(cid) <= 120 then
		doPlayerSendTextMessage(cid,22,"You need 120 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8102 then
	if isGM or getPlayerStorageValue(cid,8102) <= 0 then
...
elseif item.uid == 8103 then
	if isGM or getPlayerStorageValue(cid,8103) <= 0 then
...
elseif item.uid == 8104 then
	if isGM or getPlayerStorageValue(cid,8104) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8105 then
	if isGM or getPlayerStorageValue(cid,8105) <= 0 then
		if getPlayerFreeCap(cid) <= 5 then
		doPlayerSendTextMessage(cid,22,"You need 5 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8106 then
	if isGM or getPlayerStorageValue(cid,8106) <= 0 then
		if getPlayerFreeCap(cid) <= 19 then
		doPlayerSendTextMessage(cid,22,"You need 19 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8107 then
	if isGM or getPlayerStorageValue(cid,8107) <= 0 then
...
elseif item.uid == 8108 then
	if isGM or getPlayerStorageValue(cid,8108) <= 0 then
		if getPlayerFreeCap(cid) <= 9 then
		doPlayerSendTextMessage(cid,22,"You need 9 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8109 then
	if isGM or getPlayerStorageValue(cid,8109) <= 0 then
		if getPlayerFreeCap(cid) <= 9 then
		doPlayerSendTextMessage(cid,22,"You need 9 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8110 then
	if isGM or getPlayerStorageValue(cid,8110) <= 0 then
		if getPlayerFreeCap(cid) <= 9 then
		doPlayerSendTextMessage(cid,22,"You need 9 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8113 then
	if isGM or getPlayerStorageValue(cid,8113) <= 0 then
...
elseif item.uid == 8114 then
	if isGM or getPlayerStorageValue(cid,8114) <= 0 then
		if getPlayerFreeCap(cid) <= 105 then
		doPlayerSendTextMessage(cid,22,"You need 105 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8115 then
	if isGM or getPlayerStorageValue(cid,8115) <= 0 then
		if getPlayerFreeCap(cid) <= 4 then
		doPlayerSendTextMessage(cid,22,"You need 4 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8116 then
	if isGM or getPlayerStorageValue(cid,8116) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8117 then
	if isGM or getPlayerStorageValue(cid,8117) <= 0 then
		if getPlayerFreeCap(cid) <= 50 then
		doPlayerSendTextMessage(cid,22,"You need 50 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8118 then
	if isGM or getPlayerStorageValue(cid,8118) <= 0 then
		if getPlayerFreeCap(cid) <= 50 then
		doPlayerSendTextMessage(cid,22,"You need 50 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8119 then
	if isGM or getPlayerStorageValue(cid,8119) <= 0 then
		if getPlayerFreeCap(cid) <= 9 then
		doPlayerSendTextMessage(cid,22,"You need 9 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8120 then
	if isGM or getPlayerStorageValue(cid,8120) <= 0 then
...
elseif item.uid == 8121 then
	if isGM or getPlayerStorageValue(cid,8121) <= 0 then
...
elseif item.uid == 8122 then
	if isGM or getPlayerStorageValue(cid,8122) <= 0 then
		if getPlayerFreeCap(cid) <= 6 then
		doPlayerSendTextMessage(cid,22,"You need 6 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8123 then
	if isGM or getPlayerStorageValue(cid,8123) <= 0 then
		if getPlayerFreeCap(cid) <= 5 then
		doPlayerSendTextMessage(cid,22,"You need 5 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8124 then
	if isGM or getPlayerStorageValue(cid,8124) <= 0 then
		if getPlayerFreeCap(cid) <= 68 then
		doPlayerSendTextMessage(cid,22,"You need 68 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8125 then
	if isGM or getPlayerStorageValue(cid,8125) <= 0 then
		if getPlayerFreeCap(cid) <= 52 then
		doPlayerSendTextMessage(cid,22,"You need 52 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8126 then
	if isGM or getPlayerStorageValue(cid,8126) <= 0 then
		if getPlayerFreeCap(cid) <= 10 then
		doPlayerSendTextMessage(cid,22,"You need 10 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8127 then
	if isGM or getPlayerStorageValue(cid,8127) <= 0 then
...
elseif item.uid == 8133 then
	if isGM or getPlayerStorageValue(cid,8133) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8134 then
	if isGM or getPlayerStorageValue(cid,8134) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8135 then
	if isGM or getPlayerStorageValue(cid,8135) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8136 then
	if isGM or getPlayerStorageValue(cid,8136) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8137 then
	if isGM or getPlayerStorageValue(cid,8137) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8138 then
	if isGM or getPlayerStorageValue(cid,8138) <= 0 then
		if getPlayerFreeCap(cid) <= 30 then
		doPlayerSendTextMessage(cid,22,"You need 30 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8139 then
	if isGM or getPlayerStorageValue(cid,8139) <= 0 then
...
elseif item.uid == 8140 then
	if isGM or getPlayerStorageValue(cid,8140) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8141 then
	if isGM or getPlayerStorageValue(cid,8141) <= 0 then
		if getPlayerFreeCap(cid) <= 82 then
		doPlayerSendTextMessage(cid,22,"You need 82 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8142 then
	if isGM or getPlayerStorageValue(cid,8142) <= 0 then
...
elseif item.uid == 25302 then
	if isGM or getPlayerStorageValue(cid,25302) <= 0 then
		if getPlayerFreeCap(cid) <= 10 then
		doPlayerSendTextMessage(cid,22,"You need 10 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 25303 then
	if isGM or getPlayerStorageValue(cid,25303) <= 0 then
		if getPlayerFreeCap(cid) <= 8 then
		doPlayerSendTextMessage(cid,22,"You need 8 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8143 then
	if isGM or getPlayerStorageValue(cid,8143) <= 0 then
...
elseif item.uid == 8144 then
	if isGM or getPlayerStorageValue(cid,8144) <= 0 then
		if getPlayerFreeCap(cid) <= 9 then
		doPlayerSendTextMessage(cid,22,"You need 9 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8145 then
	if isGM or getPlayerStorageValue(cid,8145) <= 0 then
		if getPlayerFreeCap(cid) <= 3 then
		doPlayerSendTextMessage(cid,22,"You need 3 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8146 then
	if isGM or getPlayerStorageValue(cid,8146) <= 0 then
		if getPlayerFreeCap(cid) <= 34 then
		doPlayerSendTextMessage(cid,22,"You need 34 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8147 then
	if isGM or getPlayerStorageValue(cid,8147) <= 0 then
...
elseif item.uid == 8148 then
	if isGM or getPlayerStorageValue(cid,8148) <= 0 then
...
elseif item.uid == 8149 then
	if isGM or getPlayerStorageValue(cid,8149) <= 0 then
		if getPlayerFreeCap(cid) <= 4 then
		doPlayerSendTextMessage(cid,22,"You need 4 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8150 then
	if isGM or getPlayerStorageValue(cid,8150) <= 0 then
...
elseif item.uid == 8151 then
	if isGM or getPlayerStorageValue(cid,8151) <= 0 then
		if getPlayerFreeCap(cid) <= 54 then
		doPlayerSendTextMessage(cid,22,"You need 54 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8152 then
	if isGM or getPlayerStorageValue(cid,8152) <= 0 then
		if getPlayerFreeCap(cid) <= 5 then
		doPlayerSendTextMessage(cid,22,"You need 5 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8153 then
	if isGM or getPlayerStorageValue(cid,8153) <= 0 then
...
elseif item.uid == 8154 then
	if isGM or getPlayerStorageValue(cid,8154) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8155 then
	if isGM or getPlayerStorageValue(cid,8155) <= 0 then
...
elseif item.uid == 8156 then
	if isGM or getPlayerStorageValue(cid,8156) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8159 then
	if isGM or getPlayerStorageValue(cid,8159) <= 0 then
...
elseif item.uid == 8160 then
	if isGM or getPlayerStorageValue(cid,8160) <= 0 then
		if getPlayerFreeCap(cid) <= 80 then
		doPlayerSendTextMessage(cid,22,"You need 80 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8167 then
	if isGM or getPlayerStorageValue(cid,8167) <= 0 then
		if getPlayerFreeCap(cid) <= 13 then
		doPlayerSendTextMessage(cid,22,"You need 13 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8174 then
	if isGM or getPlayerStorageValue(cid,8174) <= 0 then
...
elseif item.uid == 8180 then
	if isGM or getPlayerStorageValue(cid,8180) <= 0 then
...
elseif item.uid == 8181 then
	if isGM or getPlayerStorageValue(cid,8181) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8182 then
	if isGM or getPlayerStorageValue(cid,8182) <= 0 then
		if getPlayerFreeCap(cid) <= 40 then
		doPlayerSendTextMessage(cid,22,"You need 40 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8185 then
	if isGM or getPlayerStorageValue(cid,8185) <= 0 then
		if getPlayerFreeCap(cid) <= 10 then
		doPlayerSendTextMessage(cid,22,"You need 10 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8186 then
	if isGM or getPlayerStorageValue(cid,8186) <= 0 then
		if getPlayerFreeCap(cid) <= 8 then
		doPlayerSendTextMessage(cid,22,"You need 8 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8187 then
	if isGM or getPlayerStorageValue(cid,8187) <= 0 then
...
elseif item.uid == 8188 then
	if isGM or getPlayerStorageValue(cid,8188) <= 0 then
		if getPlayerFreeCap(cid) <= 9 then
		doPlayerSendTextMessage(cid,22,"You need 9 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8189 then
	if isGM or getPlayerStorageValue(cid,8189) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8190 then
	if isGM or getPlayerStorageValue(cid,8190) <= 0 then
		if getPlayerFreeCap(cid) <= 12 then
		doPlayerSendTextMessage(cid,22,"You need 12 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8192 then
	if isGM or getPlayerStorageValue(cid,8192) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8200 then
	if isGM or getPlayerStorageValue(cid,8200) <= 0 then
		if getPlayerFreeCap(cid) < 10 then
		doPlayerSendTextMessage(cid,22,"You need 10 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8201 then
	if isGM or getPlayerStorageValue(cid,8201) <= 0 then
		if getPlayerFreeCap(cid) < 23 then
		doPlayerSendTextMessage(cid,22,"You need 23 cap or more to loot this!")
		return TRUE
		end
		doPlayerSendTextMessage(cid,22,"You have found a yellow spell wand!")
		doPlayerAddItem(cid, Cfwandofcosmicenergy, 1)
...
elseif item.uid == 8202 then
	if isGM or getPlayerStorageValue(cid,8202) <= 0 then
		if getPlayerFreeCap(cid) < 7 then
		doPlayerSendTextMessage(cid,22,"You need 7 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8203 then
	if isGM or getPlayerStorageValue(cid,8203) <= 0 then
		if getPlayerFreeCap(cid) < 7 then
		doPlayerSendTextMessage(cid,22,"You need 7 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8206 then
	if isGM or getPlayerStorageValue(cid,8206) <= 0 then
		if getPlayerFreeCap(cid) < 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8207 then
	if isGM or getPlayerStorageValue(cid,8207) <= 0 then
		if getPlayerFreeCap(cid) < 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8208 then
	if isGM or getPlayerStorageValue(cid,8208) <= 0 then
		if getPlayerFreeCap(cid) < 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8209 then
	if isGM or getPlayerStorageValue(cid,8209) <= 0 then
		if getPlayerFreeCap(cid) < 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8210 then
	if isGM or getPlayerStorageValue(cid,8210) <= 0 then
		if getPlayerFreeCap(cid) < 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8211 then
	if isGM or getPlayerStorageValue(cid,8211) <= 0 then
...
elseif item.uid == 8212 then
	if isGM or getPlayerStorageValue(cid,8212) <= 0 then
		if getPlayerFreeCap(cid) < 0 then
		doPlayerSendTextMessage(cid,22,"You need 0 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8220 then
	if isGM or getPlayerStorageValue(cid,8220) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8221 then
	if isGM or getPlayerStorageValue(cid,8221) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8222 then
	if isGM or getPlayerStorageValue(cid,8222) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8223 then
	if isGM or getPlayerStorageValue(cid,8223) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 10059 then
	if isGM or getPlayerStorageValue(cid,10059) <= 0 then
		if getPlayerFreeCap(cid) <= 8 then
		doPlayerSendTextMessage(cid,22,"You need 8 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 10058 then
	if isGM or getPlayerStorageValue(cid,10058) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 10060 then
	if isGM or getPlayerStorageValue(cid,10060) <= 0 then
		if getPlayerFreeCap(cid) <= 10 then
		doPlayerSendTextMessage(cid,22,"You need 10 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8224 then
	if isGM or getPlayerStorageValue(cid,8224) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8225 then
	if isGM or getPlayerStorageValue(cid,8225) <= 0 then
		if getPlayerFreeCap(cid) <= 23 then
		doPlayerSendTextMessage(cid,22,"You need 23 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8226 then -- Dragon Lord Mountain Quest
	if isGM or getPlayerStorageValue(cid,8226) <= 0 then
		if getPlayerFreeCap(cid) <= 23 then
		doPlayerSendTextMessage(cid,22,"You need 23 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8227 then -- Hellfire Fighter Quest
	if isGM or getPlayerStorageValue(cid,8227) <= 0 then
		if getPlayerFreeCap(cid) <= 23 then
		doPlayerSendTextMessage(cid,22,"You need 23 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8228 then -- Undead Dragon Quest
	if isGM or getPlayerStorageValue(cid,8228) <= 0 then
		if getPlayerFreeCap(cid) <= 23 then
		doPlayerSendTextMessage(cid,22,"You need 23 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8229 then -- Undead Dragon Quest
	if isGM or getPlayerStorageValue(cid,8229) <= 0 then
		if getPlayerFreeCap(cid) <= 23 then
		doPlayerSendTextMessage(cid,22,"You need 23 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8230 then -- Behemoth Quest
	if isGM or getPlayerStorageValue(cid,8230) <= 0 then
		if getPlayerFreeCap(cid) <= 23 then
		doPlayerSendTextMessage(cid,22,"You need 23 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8231 then -- Demon Quest
	if isGM or getPlayerStorageValue(cid,8231) <= 0 then
		if getPlayerFreeCap(cid) <= 23 then
		doPlayerSendTextMessage(cid,22,"You need 23 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8232 then -- Hero Quest
	if isGM or getPlayerStorageValue(cid,8232) <= 0 then
		if getPlayerFreeCap(cid) <= 23 then
		doPlayerSendTextMessage(cid,22,"You need 23 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8233 then
	if isGM or getPlayerStorageValue(cid,8233) <= 0 then
		if getPlayerFreeCap(cid) <= 50 then
		doPlayerSendTextMessage(cid,22,"You need 50 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8234 then
	if isGM or getPlayerStorageValue(cid,8234) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
