...
if item.uid == 7006 then
	if isGM or getPlayerStorageValue(cid,7006) <= 0 then
...
elseif item.uid == 7008 then
	if isGM or getPlayerStorageValue(cid,7008) <= 0 then
...
elseif item.uid == 7009 then
	if isGM or getPlayerStorageValue(cid,7009) <= 0 then
		if getPlayerFreeCap(cid) <= 7 then
		doPlayerSendTextMessage(cid,22,"You need 7 cap or more to loot this!")
		return TRUE
		end
	...
	doSetItemActionId(BEARROOMKEY, 4601)
...
elseif item.uid == 7010 then
	if isGM or getPlayerStorageValue(cid,7010) <= 0 then
...
elseif item.uid == 7011 then
	if isGM or getPlayerStorageValue(cid,7011) <= 0 then
...
elseif item.uid == 7012 then
	if isGM or getPlayerStorageValue(cid,7012) <= 0 then
		if getPlayerFreeCap(cid) <= 27 then
		doPlayerSendTextMessage(cid,22,"You need 27 cap or more to loot this!")
		return TRUE
		end
	...
	doAddContainerItem(BEARROOMBAG, Cfgoldcoin, 40)
...
elseif item.uid == 7013 then
	if isGM or getPlayerStorageValue(cid,7013) <= 0 then
...
elseif item.uid == 7014 then
	if isGM or getPlayerStorageValue(cid,7014) <= 0 then
	...
	setPlayerStorageValue(cid,7014,1) doAddQuestPoint(cid)
	else
...
elseif item.uid == 7015 then
	if isGM or getPlayerStorageValue(cid,7015) <= 0 then
	...
	setPlayerStorageValue(cid,7015,1) doAddQuestPoint(cid)
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
	end
-----
...
elseif item.uid == 7016 then
	if isGM or getPlayerStorageValue(cid,7016) <= 0 then
	...
	doAddContainerItem(GOBBLINTEMPLEBAG1, Cfgoldcoin, 50)
	setPlayerStorageValue(cid,7016,1) doAddQuestPoint(cid)
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
	end
-----
...
elseif item.uid == 7017 then
	if isGM or getPlayerStorageValue(cid,7017) <= 0 then
...
elseif item.uid == 7018 then
	if isGM or getPlayerStorageValue(cid,7018) <= 0 then
	...
	doSetItemActionId(KATANAKEY, 4603)
...
elseif item.uid == 7019 then
	if isGM or getPlayerStorageValue(cid,7019) <= 0 then
	...
	setPlayerStorageValue(cid,7019,1) doAddQuestPoint(cid)
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
	end
-----
...
elseif item.uid == 7020 then
	if isGM or getPlayerStorageValue(cid,7020) <= 0 then
	...
	setPlayerStorageValue(cid,7020,1) doAddQuestPoint(cid)
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
	end
-----
...
elseif item.uid == 7021 then
	if isGM or getPlayerStorageValue(cid,7021) <= 0 then
		if getPlayerFreeCap(cid) <= 9 then
		doPlayerSendTextMessage(cid,22,"You need 9 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 7022 then
	if isGM or getPlayerStorageValue(cid,7022) <= 0 then
...
elseif item.uid == 7023 then
	if isGM or getPlayerStorageValue(cid,7023) <= 0 then
	...
	setPlayerStorageValue(cid,7023,1) doAddQuestPoint(cid)
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
	end
-----
...
elseif item.uid == 7024 then
	if isGM or getPlayerStorageValue(cid,7024) <= 0 then
...
elseif item.uid == 7025 then
	if isGM or getPlayerStorageValue(cid,7025) <= 0 then
...
elseif item.uid == 7026 then
	if isGM or getPlayerStorageValue(cid,7026) <= 0 then
...
elseif item.uid == 7031 then
	if isGM or getPlayerStorageValue(cid,7031) <= 0 then
...
elseif item.uid == 7038 then
	if isGM or getPlayerStorageValue(cid,7038) <= 0 then
	...
	doSetItemActionId(SPIKESWORDKEY, 13)
...
elseif item.uid == 7039 then
	if isGM or getPlayerStorageValue(cid,7039) <= 0 then
		if getPlayerStorageValue(cid,7037) ~= 1 then
...
elseif item.uid == 7040 then
	if isGM or getPlayerStorageValue(cid,7040) <= 0 then
