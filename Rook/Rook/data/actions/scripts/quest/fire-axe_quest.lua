...
return TRUE
   ...
   item_uid = us_AddQuestReward(cid,2432,1)
   item_uid = us_AddQuestReward(cid,2214,1)
   item_uid = us_AddQuestReward(cid,2201,200)
   item_uid = us_AddQuestReward(cid,2145,7)
