...
static constexpr int32_t RANGE_MOVE_ITEM_INTERVAL = 50;
static constexpr int32_t RANGE_USE_ITEM_INTERVAL = 50;
static constexpr int32_t RANGE_USE_ITEM_EX_INTERVAL = 50;
static constexpr int32_t RANGE_USE_WITH_CREATURE_INTERVAL = 50;
