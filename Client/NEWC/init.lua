-- CONFIG
APP_NAME = "Rookie"  -- important, change it, it's name for config dir and files in appdata
...
Services = {
  ...
  updater = "https://tibia74.online/test/updater.php",
  stats = "",
  crash = "",
  feedback = "",
  status = ""
...
Servers = {
	...
	rookie = "100.104.149.16:7171:772"
