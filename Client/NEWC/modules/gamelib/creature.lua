...
function Creature:onSkullChange(skullId)
  if self._typeId == CreatureTypeMonster then
    if skullId == SkullGreen then
      self:setOutfitShader("variant_green")
      return
    elseif skullId == SkullOrange then
      self:setOutfitShader("variant_blue")
      return
    elseif skullId == SkullRed then
      self:setOutfitShader("variant_red")
      return
    elseif skullId == SkullNone then
      self:setOutfitShader("outfit_default")
      return
    end
  end
